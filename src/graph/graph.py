...
from src.tools.post_line_comment_node import post_line_comments_node
...
workflow.add_node("post_line_comments", post_line_comments_node)
...
workflow.add_edge("generate_report", "post_line_comments")
workflow.add_edge("post_line_comments", "post_comment")
